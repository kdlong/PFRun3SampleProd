...
curl -s -k https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/EGM-Run3Winter21GS-00001 --retry 3 --create-dirs -o Configuration/GenProduction/python/EGM-Run3Winter21GS-00001-fragment.py
[ -s Configuration/GenProduction/python/EGM-Run3Winter21GS-00001-fragment.py ] || exit $?;
scram b
cd ../..

gsdfile=EGM-Run3Summer21GS-00001_${filenum}.root 
digifile=EGM-Run3Summer21DRPremix-00001_1_${filenum}.root 
recofile=EGM-Run3Summer21DRPremix-00001_2_${filenum}.root 
minifile=EGM-Run3Summer21MiniAOD-00001_${filenum}.root 

cmsDriver.py Configuration/GenProduction/python/EGM-Run3Winter21GS-00001-fragment.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions auto:phase1_2021_realistic --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --step GEN,SIM --geometry DB:Extended --era Run3  --fileout file:$gsdfile -n $nevents --customise_commands "process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=${filenum}\nprocess.source.firstLuminosityBlock=cms.untracked.uint32(${lumi})\nprocess.source.firstEvent=cms.untracked.uint32(${firstEvent})"
